...
export const PILL_BLACK_CTA: CtaTemplate = {
  id: "pillBlackCTA",
  name: "Pill Black CTA",
  description: "Soft pill silhouette with a black aurora fill, pale specks, and cool border glow.",
  values: {
    label: "Claim Reward",
    costAmount: "",
    costIcon: "💎",
    ...
    hexTip: 0.27,
    strokeWidth: 1,
    strokeColor: "rgba(210, 216, 226, 0.42)",
    auroraA: "#2a2d33",
    auroraB: "#050608",
    auroraMid: "#111318",
    auroraC: "#3a3f48",
    ...
    auroraBandHeight: 1.4,
    auroraRotation: 16,
    auroraBaseColor: "#050608",
    particleCount: 12,
    particleSize: 0.022,
    particleSpeed: 2.6,
    particleOpacity: 0.55,
    particleColor: "#e8edf4",
    particleTwinkle: 0.62,
    labelColor: "#f4f6f8",
    fontSize: 18,
    glowEnabled: true,
